...
public class PostgresDAO {
    ...
    public void registerUser(String email, String prefer_name, String password) throws SQLException {
        String query = "INSERT INTO users(email, prefer_name, password, rides, isdriver, availablecoupons, redeemedcoupons) VALUES('%s','%s','%s', %d, '%s','%s', '%s')";
    ...
    public void clearDb() throws SQLException {
        String query1 = "TRUNCATE users";
        this.st.execute(query1);
    }
    // *** implement database operations here *** //
}
